...
export type MeQuery = { me: { id: number, name: string, role: number } | null };
...
export type LoginMutation = { login: { user: { id: number, name: string, role: number } } };

export type UserTableFieldsFragment = { id: number, name: string, email: string, role: number, createdAt: string } & { ' $fragmentName'?: 'UserTableFieldsFragment' };
